...
String action = request.getParameter("qq");
if(action != null && action.trim().equals("QQ")) {
  new Login();
...
<div id="wrap">
	...
	<div id="header">
      ...
      <div id="welcome">欢迎来到网上水果商城!<a href="Loginin.jsp">&nbsp;&nbsp;登录</a>&nbsp;&nbsp;<a href="Register.jsp">注册</a></div>
      <div id="myacount"></div>
     
      <div id="cab"><a href="maycab.jsp"><img src="images/cab0.png" alt="购物车" /></a></div>
      <form name="qq1" action="Index.jsp" method="get">
      <input type="hidden" name="qq" value="QQ" />
      
      <div id="phoneno"><input type="submit" value="联系客服"/></div>
      </form>
      ...
      <form name="simple" action="LikeSearch.jsp" method="get">
        ...
        <a href="Logout.jsp">退出账号</a><a href="AdminLogin1.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;后台登陆</a></div></div>
        </div>
