<%@ page language="java" import="com.zx.shopping.category.*" pageEncoding="GBK"%>
...
<html><head><title>水果商城添加根类别</title>
...
<tbody><tr><td class="nav" align="left" nowrap="nowrap" width="90%">&nbsp;水果商城 &raquo; <br></td>
