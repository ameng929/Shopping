...
style="BACKGROUND-IMAGE: url(../images/bg_nav.gif); BACKGROUND-REPEAT: repeat-x; HEIGHT: 30px">
      ...
      id=lblBra>苏州独墅湖高教区片区</SPAN> <SPAN id=lblDep>水果商城</SPAN> [系统管理员 ] 光临 </DIV>
            </TD>
            <TD align=right width="69%"><SPAN style="PADDING-RIGHT: 50px"><A 
      ...
      src="Top.files/nav_changePassword.gif" align=absMiddle border=0>退出</A> <A href="../Logout.jsp" 
